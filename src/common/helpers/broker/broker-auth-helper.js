...
const GRANTS_CONFIG_BROKER_AUTH_TOKEN = config.get('configBroker.auth.token')
const ENCRYPTION_KEY = config.get('configBroker.auth.encryptionKey')
/**
...
/**
 * Creates standard headers for API requests to grants-config-broker
